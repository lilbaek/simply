...
import static com.lilbaek.simply.simply.sql.MetadataHelper.getValuesFromInstanceForInsert;
...
public class InsertBuilder extends BaseBuilder {
    ...
    public static SqlStatement insertSql(final Object instance) {
        ...
        try {
            ...
            final var values = getValuesFromInstanceForInsert(instance, metadata.properties);
